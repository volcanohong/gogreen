...
public class Imageset extends HippoGalleryImageSet {
    ...
    @HippoEssentialsGenerated(internalName = "gogreen:largesqure")
    public HippoGalleryImageBean getLargesqure() {
        return getBean("gogreen:largesqure", HippoGalleryImageBean.class);
    }
